...
export default function RegisterPage() {
  ...
  return (
    <section className="bg-background-light">
      {/* Header */}
      <header className="w-full px-6 md:px-10 py-4 flex items-center justify-between bg-white border-b border-gray-200">
      ...
      <main className="flex-1 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-md bg-white border border-gray-100 rounded-xl shadow-xl shadow-gray-200/50 p-8 md:p-10">
          {/* Title */}
          ...
          <div className="mb-6">
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 h-12 px-5 bg-white border border-gray-300 rounded-xl text-gray-700 font-bold text-sm hover:bg-gray-50 transition-all"
            >
          ...
          <div className="relative flex items-center mb-6">
            ...
            <span className="mx-4 text-gray-400 text-xs font-bold uppercase tracking-widest">
              or
            </span>
            <div className="grow border-t border-gray-200"></div>
          </div>
